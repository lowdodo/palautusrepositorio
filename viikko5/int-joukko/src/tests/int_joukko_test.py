...
class TestIntJoukko(unittest.TestCase):
    def setUp(self):
        ...
        self.joukko.lisaa_listalle(10)
        self.joukko.lisaa_listalle(3)

    def tee_joukko(self, *luvut):
        joukko = IntJoukko()

        for luku in luvut:
            joukko.lisaa_listalle(luku)
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertEqual(joukko.listan_koko(), 14)
        self.assertTrue(joukko.kuuluuko_listalle(11))
        joukko.poista_listalta(11)
        self.assertFalse(joukko.kuuluuko_listalle(11))
        self.assertEqual(joukko.listan_koko(), 13)

    def test_lukuja_lisatty_maara(self):
        self.joukko.lisaa_listalle(4)
        self.assertEqual(self.joukko.listan_koko(), 3)

    def test_sama_luku_menee_joukkoon_vaan_kerran(self):
        self.joukko.lisaa_listalle(10)
        self.joukko.lisaa_listalle(3)
        self.assertEqual(self.joukko.listan_koko(), 2)

    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.kuuluuko_listalle(10))
        self.assertFalse(self.joukko.kuuluuko_listalle(5))
        self.assertTrue(self.joukko.kuuluuko_listalle(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista_listalta(3)
        self.assertFalse(self.joukko.kuuluuko_listalle(3))
        self.assertEqual(self.joukko.listan_koko(), 1)

    def test_palautetaan_oikea_taulukko(self):
        odotettu = [3, 55, 99]

        self.joukko.lisaa_listalle(55)
        self.joukko.poista_listalta(10)
        self.joukko.lisaa_listalle(99)
